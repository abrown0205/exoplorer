...
import { Box as RadixThemesBox, Card as RadixThemesCard, DropdownMenu as RadixThemesDropdownMenu, Flex as RadixThemesFlex, Grid as RadixThemesGrid, Heading as RadixThemesHeading, Link as RadixThemesLink, Text as RadixThemesText } from "@radix-ui/themes"
...
export default function Component() {
  ...
  <img css={{"width": "80%", "margin": "auto"}} src={`../../new_logo.png`}/>
  <RadixThemesGrid columns={`2`} css={{"width": "100%"}} gap={`4`}>
  <RadixThemesCard css={{"textAlign": "center"}}>
  <RadixThemesLink asChild={true} css={{"&:hover": {"color": "var(--accent-8)"}}}>
  <NextLink href={`/generate`} passHref={true}>
  <RadixThemesHeading css={{"fontFamily": "Orbitron", "--default-font-family": "Orbitron", "fontWeight": "400"}} size={`6`}>
  {`Build your own exoplanet!`}
</RadixThemesHeading>
</NextLink>
</RadixThemesLink>
</RadixThemesCard>
  ...
  <NextLink href={`/learn`} passHref={true}>
  <RadixThemesHeading css={{"fontFamily": "Orbitron", "--default-font-family": "Orbitron", "fontWeight": "400"}} size={`6`}>
  {`Learn about key exoplanet features!`}
</RadixThemesHeading>
</NextLink>
</RadixThemesLink>
</RadixThemesCard>
