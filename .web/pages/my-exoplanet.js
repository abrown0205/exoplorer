...
export function Img_9a8a85c24afe0003ea236baba6269555 () {
  ...
  return (
    <img css={{"minWidth": "250px", "height": "auto"}} src={reflex___state____state__space_apps___state___generate_state____generate_state.generated_data["picture_path"]}/>
  )
}

export function Table__body_4a2124d2a7a6da615986088925743973 () {
  const reflex___state____state__space_apps___state___generate_state____generate_state = useContext(StateContexts.reflex___state____state__space_apps___state___generate_state____generate_state)
  ...
  {reflex___state____state__space_apps___state___generate_state____generate_state.get_generated_data.map((data_point, index_e454555d84bf4987) => (
...
export function Text_e767f55905d027a2f41a95f7c0d20d97 () {
  const reflex___state____state__space_apps___state___generate_state____generate_state = useContext(StateContexts.reflex___state____state__space_apps___state___generate_state____generate_state)
  ...
  return (
    <RadixThemesText as={`p`}>
  {reflex___state____state__space_apps___state___generate_state____generate_state.updated_description}
</RadixThemesText>
  )
}
...
export function Debounceinput_dd6636f24a08f620c9de0bb09717c07b () {
  const reflex___state____state__space_apps___state___generate_state____generate_state = useContext(StateContexts.reflex___state____state__space_apps___state___generate_state____generate_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);

  const on_change_1f58aba6fe15def6f4876e81d09dfa8c = useCallback((_e0) => addEvents([Event("reflex___state____state.space_apps___state___generate_state____generate_state.set_name", {name:_e0.target.value})], [_e0], {}), [addEvents, Event])


  return (
    <DebounceInput css={{"width": "50%", "height": "auto", "margin": "auto", "textAlign": "center", "fontSize": "30px"}} debounceTimeout={300} element={RadixThemesTextField.Root} onChange={on_change_1f58aba6fe15def6f4876e81d09dfa8c} value={reflex___state____state__space_apps___state___generate_state____generate_state.generated_name}/>
  )
}
...
export default function Component() {
  ...
  <RadixThemesHeading css={{"fontFamily": "Orbitron", "--default-font-family": "Orbitron", "fontWeight": "400"}}>
  <Debounceinput_dd6636f24a08f620c9de0bb09717c07b/>
</RadixThemesHeading>
  <RadixThemesFlex align={`center`} css={{"padding": "5%"}} justify={`between`} gap={`9`}>
  <Img_9a8a85c24afe0003ea236baba6269555/>
  <Text_e767f55905d027a2f41a95f7c0d20d97/>
</RadixThemesFlex>
  ...
  <Table__body_4a2124d2a7a6da615986088925743973/>
</RadixThemesTable.Root>
